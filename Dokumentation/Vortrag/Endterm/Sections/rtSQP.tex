...
\begin{block}{}
%\begin{align*}
\[  \min_{x, u} \sum_{i=t}^{N} J_{i}(x_{i},u_{i}) \qquad  
  \text{s.t.} \quad 
...
\draw<3->[blue,fill=blue] (0.1,0) rectangle (0.15, 1);
%Prepare for t_k
\draw<4->[green, fill=green] (0.15,0) rectangle (5,1);
\end{tikzpicture}
\end{figure}
...
\end{enumerate}
\onslide<5->
$ \Rightarrow $ with horizon $ 15 $ this is $ 25\% $ faster.
\end{frame}
