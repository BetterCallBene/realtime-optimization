...
\draw  
	...
	node[neutral, above=of e.east, anchor=east] (g) {SQP}
	node[neutral, above=of r.west, minimum width=7cm, anchor=west] (d) {Problemformulation}
	node[neutral, above=of d.west, anchor=west] (b) {Quaternions} 
	node[neutral, above=of d.east, anchor=east] (c) {Discretization}
	node[neutral, minimum width=3.145cm, above=of b.west, anchor=west] (a) {Model}
	;
	...
	\draw<2->
	node[aktiv, above=of r.west, minimum width=7cm, anchor=west] (d) {Problemformulation}
	node[aktiv, minimum width=3.145cm, above=of b.west, anchor=west] (a) {Model} 
	;
\end{tikzpicture}
