...
Minv := Matrix(6, 6, {(1, 1) = 1/m, (1, 2) = 0, (1, 3) = 0, (1, 4) = 0, (1, 5) = 0, (1, 6) = 0, (2, 1) = 0, (2, 2) = 1/m, (2, 3) = 0, (2, 4) = 0, (2, 5) = 0, (2, 6) = 0, (3, 1) = 0, (3, 2) = 0, (3, 3) = 1/m, (3, 4) = 0, (3, 5) = 0, (3, 6) = 0, (4, 1) = 0, (4, 2) = 0, (4, 3) = 0, (4, 4) = 1/I[1], (4, 5) = 0, (4, 6) = 0, (5, 1) = 0, (5, 2) = 0, (5, 3) = 0, (5, 4) = 0, (5, 5) = 1/I[2], (5, 6) = 0, (6, 1) = 0, (6, 2) = 0, (6, 3) = 0, (6, 4) = 0, (6, 5) = 0, (6, 6) = 1/I[3]});
...
Theta := proc (q, v, omega) options operator, arrow; Vector(6, {(1) = m*(omega[2]*v[3]-omega[3]*v[2]+R3(q)[1]*g), (2) = m*(omega[3]*v[1]-omega[1]*v[3]+R3(q)[2]*g), (3) = m*(omega[1]*v[2]-omega[2]*v[1]+R3(q)[3]*g), (4) = I[3]*omega[2]*omega[3]-I[2]*omega[3]*omega[2], (5) = I[1]*omega[3]*omega[1]-I[3]*omega[1]*omega[3], (6) = I[2]*omega[1]*omega[2]-I[1]*omega[2]*omega[1]}) end proc;
...
dot := Vector([Multiply(R(q), xv[8 .. 10]), Q, Multiply(Minv, T(omega, u)-Theta(q, v, omega))]);
...
currentdir(tmpDir);
if TEST = false then Matlab(dynM, optimize, defaulttype = integer, output = tmpRTOptFunction)*Matlab(J, optimize, defaulttype = integer, output = tmpRTOptJacobi)*Matlab(H, optimize, defaulttype = integer, output = tmpRTOptHesse) end if;
